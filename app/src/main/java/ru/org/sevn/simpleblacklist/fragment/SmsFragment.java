 ...
 */
public class SmsFragment extends Fragment implements Titled {
    private static final String title = "SMS";
    ...
    private void initRadioButtons(final AppHelper appHelper, final ViewActivityWrapper vw) {
        ...
        radioGroup = (RadioGroup) vw.findViewById(R.id.radioGrpModeSms);
        radioAllowAll = (RadioButton) vw.findViewById(R.id.radioAllowAllSms);
        radioAllowWList = (RadioButton) vw.findViewById(R.id.radioAllowWListSms);
        radioDisableBList = (RadioButton) vw.findViewById(R.id.radioDisableBListSms);

        switch (appHelper.getAppSettings().getModeSms()) {
            ...
            radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(RadioGroup group, int checkedId) {
                    ...
                    if (radioAllowWList != null && radioAllowWList.getId() == checkedId) {
                        appSettings.setModeSms(AppSettings.radioAllowWList);
                    } else if (radioDisableBList != null && radioDisableBList.getId() == checkedId) {
                        appSettings.setModeSms(AppSettings.radioDisableBList);
                    } else {
                        appSettings.setModeSms(AppSettings.radioAllowAll);
                    }
